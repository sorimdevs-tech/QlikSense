...
// import { fetchSummary } from "../api/qlikApi";
...
//   useEffect(() => {
//     fetchSummary(appId).then((res) => setSummary(res.summary));
//   }, [appId]);
...
//         <button>Export to Power BI</button>
//       </div>
//     </div>
//   );
// // }
...
// import { useEffect, useState } from "react";
// import { useLocation } from "react-router-dom";
// import { fetchAISummary, fetchTables, fetchTableData } from "../api/qlikApi";
...
//     fetchAISummary(appId).then(setSummary);
...
//     const data = await fetchTableData(appId, table);
//     setRows(data);
//   };
...
//   const exportPowerBI = () => {
//     alert(
//       "Next Step: Convert CSV → Power BI using connector / API"
//     );
//   };

//   if (loading) return <div className="wrap">Generating summary… 🤖</div>;

//   return (
//     <div className="wrap">
//       <h2>AI Migration Summary</h2>
...
//       {tables.map((t) => (
//         <div key={t.name}>
//           <button onClick={() => loadData(t.name)}>
//             {t.name}
//           </button>
//         </div>
//       ))}
...
//       {selectedTable && (
//         <>
//           <h3>Data Preview – {selectedTable}</h3>
...
//   // ======================================
//   // STEP 1 → GET FIRST APP AUTOMATIC
//   // ======================================
//   useEffect(() => {
...
//   // ======================================
//   // STEP 2 → LOAD TABLES WHEN APP READY
//   // ======================================
//   useEffect(() => {

//     if (!appId) return;

//     console.log("📥 Loading tables for app:", appId);
